      ...
      <div className="relative z-10 w-full max-w-md space-y-12">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-black tracking-tighter uppercase font-clean">Authorize Entry</h1>
            <p className="text-muted-foreground font-medium uppercase tracking-widest text-[10px]">Identify yourself to access your global memory</p>
          </div>
        </div>
        ...
        <p className="text-center text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground">
          Need assistance? <span className="text-foreground border-b border-border hover:border-foreground transition-colors cursor-pointer">Protocol Support</span>
        </p>
      </div>
    </div>
  );
