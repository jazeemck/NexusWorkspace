        ...
        <div className="max-w-4xl space-y-8">
          ...
          <div className="space-y-6">
            <h4 className="text-4xl font-bold tracking-tight text-foreground leading-tight">
              Your library is strong in <span className="opacity-40">AI Applications</span> but contains zero content on <span className="underline underline-offset-8 font-black">AI Ethics or Policy</span>.
            </h4>
            <p className="text-muted-foreground text-xl font-medium leading-relaxed max-w-3xl">
              Understanding the systemic and ethical guardrails of artificial intelligence is a critical counterbalance for your current research subject. Focus on integrating governance frameworks into your next synthesis.
            </p>
          </div>
        </div>
      </div>
